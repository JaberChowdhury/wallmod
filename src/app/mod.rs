...
pub struct WallmodApp {
    ...
    pub favorite_palette_selection: std::collections::HashSet<String>,
    pub show_header_dropdown: bool,
    ...
    pub code_render_bg_color: String,
    pub code_render_pad_horiz: u32,
    pub code_render_pad_vert: u32,
    pub code_render_corner_radius: u32,
    pub code_render_font: String,

    // Comprehensive Silicon Features
    pub code_render_line_number: bool,
    pub code_render_line_offset: u32,
    pub code_render_line_pad: u32,
    pub code_render_window_controls: bool,
    pub code_render_tab_width: u8,
    pub code_render_shadow_color: String,
    pub code_render_blur_radius: f32,
    pub code_render_shadow_offset_x: i32,
    pub code_render_shadow_offset_y: i32,
...
impl WallmodApp {
    pub fn new() -> Self {
        ...
        Self {
            ...
            favorite_palette_selection: std::collections::HashSet::new(),
            show_header_dropdown: false,
            ...
            code_render_bg_color: "#abb8c3".to_string(),
            code_render_pad_horiz: 80,
            code_render_pad_vert: 100,
            code_render_corner_radius: 5,
            code_render_font: "Hack".to_string(),
            code_render_line_number: true,
            code_render_line_offset: 1,
            code_render_line_pad: 2,
            code_render_window_controls: true,
            code_render_tab_width: 4,
            code_render_shadow_color: "#55000000".to_string(),
            code_render_blur_radius: 0.0,
            code_render_shadow_offset_x: 0,
            code_render_shadow_offset_y: 0,
